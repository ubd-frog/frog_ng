...
export class ReleaseNotesService {
    ...
    public allnotes: ReplaySubject<ReleaseNote[]>;
    ...
    constructor(private http: HttpClient, private storage: StorageService, private errors: ErrorService) {
        ...
        this.allnotes = new ReplaySubject<ReleaseNote[]>();
        this.get();
    }
    get() {
    ...
    getAll() {
        ...
        this.http.get(url).map(this.errors.extractValues).subscribe(values => {
            this.allnotes.next(values);
        });
    }
}
